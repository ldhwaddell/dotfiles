...
# Set preferred languages to English and French (Canada)
defaults write NSGlobalDomain AppleLanguages -array "en-CA" "fr-CA"

# Set locale to Canadian English with currency as CAD
defaults write NSGlobalDomain AppleLocale -string "en_CA@currency=CAD"

# Set measurement units to metric (Centimeters)
...
sudo systemsetup -settimezone "America/Halifax" > /dev/null
...
# Make sleep timeout shorter than system timeout
