...
local function copy_absolute_path()
	...
	vim.fn.setreg("+", path)
	print("Copied abslute path: " .. path)
end

vim.keymap.set("n", "<leader>cr", copy_relative_path, { desc = "[C]opy [R]elative path" })
vim.keymap.set("n", "<leader>ca", copy_absolute_path, { desc = "[C]opy [A]bsolute path" })
